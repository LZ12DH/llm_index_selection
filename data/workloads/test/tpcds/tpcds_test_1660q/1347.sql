...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 63 and 63+10 
             or ss_coupon_amt between 1303 and 1303+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 139 and 139+10
          or ss_coupon_amt between 4771 and 4771+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 78 and 78+10
          or ss_coupon_amt between 17774 and 17774+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 38 and 38+10
          or ss_coupon_amt between 12478 and 12478+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 181 and 181+10
          or ss_coupon_amt between 1776 and 1776+1000
