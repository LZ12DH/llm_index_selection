...
from distill_utils.distill_const import ops_dict
from distill_utils import distill_com
from distill_model import XGBoost, RandomForest
from distill_utils.distill_loss import QError, xgb_QError, lgb_QError, cal_mape
from distill_dataset import PlanPairDataset, unnormalize, normalize


def eval_model(model_type='RandomForest'):
    # : 1. get the params.
    ...
    args.test_data_load = "../data/plan_raw_feat_tpcds_infer.json"
    ...
    if args.model_type == "PG":
        ...
        # args.scale_load = "../models/xgboost_tpchtpcds/data/train_scale_data.pt"

        # args.model_type = "LightGBM"
        # args.scale_load = "../models/lightgbm_tpchtpcds/data/train_scale_data.pt"

        args.model_type = "RandomForest"
        args.scale_load = "../models/randomforest_tpchtpcds/data/train_scale_data.pt"

        scaler = torch.load(args.scale_load)
        X_test = np.array(scaler.transform(X_test), dtype=np.float32)

        # args.model_type = "XGBoost"
        # args.model_load = "../models/xgboost_tpchtpcds/model/reg_xgb_cost.xgb.model"

        # args.model_type = "LightGBM"
        # args.model_load = "../models/lightgbm_tpchtpcds/model/reg_lgb_cost.lgb.model"

        args.model_type = "RandomForest"
        args.model_load = "../models/randomforest_tpchtpcds/model/reg_rf_cost.rf.joblib"
